...
@section('page title','Half Product')
                              ...
                              <div class="table-responsive">
                                <table class="table table-hover text-center" id="">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><a href="/admin/inventory-config/half_product/half_detail">Beef Patty</a></td>
                                            <td>500 gr</td>
                                            <td>44,188</td>
                                            <td>4418</td>
                                            <td>48606</td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><a href="/admin/inventory-config/half_product/half_detail">Saus BBQ</a></td>
                                            <td>300 gr</td>
                                            <td>4673</td>
                                            <td>467</td>
                                            <td>5140</td>
